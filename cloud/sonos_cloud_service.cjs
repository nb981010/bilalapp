#!/usr/bin/env node
/*
  Sonos Cloud microservice (CommonJS copy)
  This file mirrors `sonos_cloud_service.js` but uses CommonJS to run under projects with "type": "module".
*/
...
app.listen(PORT, () => {
  ensureTable();
  console.log(`Sonos Cloud microservice (CJS) listening on port ${PORT}`);
});
